    ...
    ) : IPasswordGeneratorService
{
    ...
    public string GetValidatePassword(string password, User user)
    {
    ...
    private char GetPasswordElement(PasswordElementType passwordElementType)
    {
        return passwordElementType switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(passwordElementType), passwordElementType, "Invalid password element type")
        };
    }
